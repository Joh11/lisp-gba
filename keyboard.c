...
// Font
static const uint32 font[] = {0xf7f3f7ff, 0xe3f7f7f7, 0xdfdbe7ff, 0xc3fbf7ef, 0xdfdbe7ff, 0xe7dbdfe7, 0xdbd7cfff, 0xdfdfdfc3, 0xe3fbc3ff, 0xe3dfdfdf, 0xfbf7efff, 0xe7dbdbe3, 0xdfdfc3ff, 0xf7f7f7ef, 0xdbdbe7ff, 0xe7dbdbe7, 0xdbdbe7ff, 0xf7efdfc7, 0xcbdbe7ff, 0xe7dbdbd3, 0xffdfdfff, 0xffffffff, 0xdbdbe7ff, 0xdfdfc7db, 0xffffffff, 0xebd5d5dd, 0xe7ffffff, 0xc7fbc3db, 0xcbffffff, 0xfbfbfbf3, 0xfbe1fbff, 0xf7ebfbfb, 0xdbdbdbff, 0xe7dfdfc7, 0xdbffffff, 0xc7dbdbdb, 0xefffffff, 0xefefefff, 0xe7ffffff, 0xe7dbdbdb, 0xdbdbe7ff, 0xfbfbfbe3, 0xffffffff, 0xffdfffff, 0xe7ffffff, 0xc7dbc7df, 0xc7ffffff, 0xe3dfe7fb, 0xdfdfffff, 0xc7dbdbc7, 0xfbdbe7ff, 0xfbfbe3fb, 0xdbc7ffff, 0xe7dfc7db, 0xfbfbffff, 0xdbdbdbe3, 0xefffefff, 0xf7ebefef, 0xdbdbfbff, 0xdbdbdbe3, 0xfbfbfbff, 0xf7fbfbfb, 0xdfffffff, 0xefdfffff, 0xffffffff, 0xffffffe3, 0xc3ffffff, 0xc3fbe7df, 0xdbffffff, 0xdbdbe7db, 0xe7ffffff, 0xe7dbfbdb, 0xbbffffff, 0xefd7bbbb, 0xfbfbfbff, 0xe3dbdbe3, 0xffffffff, 0xdbdbdbe3, 0xffffffff, 0xabababc3, 0xfbfbf7ff, 0xf7fbfbfb, 0xefeff7ff, 0xf7efefef, 0xf7ffffff, 0xfffff7e3, 0xe3ffffff, 0xffffe3ff};

// cursor
static const bitpacked_tile4 cursor = {0xfefefefe, 0xfefefefe};

#define LINE_LEN 30
static const uint8 char_lut[45] = "1234567890'qwertyuiop.asdfghjkl;-zxcvbnm()+= ";
...
void init_keyboard()
{
    ...
    unpack_monochrome_tiles(cursor, &tile_mem[4][49], 1, 0x0, 0x2);
...
void update_line()
{
    oam[45].attr0 = 0 // y coord
	| (0b00 << 0xe); // sprite shape (8x8)
    oam[45].attr1 = 8 * text_pos // x coord
	| (0b00 << 0xe); // sprite size (8x8)
    oam[45].attr2 = 49 // tile index
	| (0b10 << 0xA) // priority
	| (0b00 << 0xC); // palette-bank
    
    for(size_t i = 0; i < LINE_LEN ; ++i)
    {
	oam[46+i].attr0 = 0 // y coord
	    | (0b00 << 0xe); // sprite shape (8x8)
	oam[46+i].attr1 = 8 * i // x coord
	    | (0b00 << 0xe); // sprite size (8x8)
	oam[46+i].attr2 = ((text[i] == 255) ? 0 : 5+text[i]) // tile index
	    | (0b10 << 0xA) // priority
	    | (0b00 << 0xC); // palette-bank
    }
}
